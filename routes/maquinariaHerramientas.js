...
router.post(
  ...
  [
    ...
    check("Id_proveedor").custom(
      maquinariaHerramientasHelpers.validarIdProveedor
    ),
    ...
    check("mantenimiento.*.Fecha", "La Fecha es obligatoria")
      .optional({ checkFalsy: true })
      .not()
      .isEmpty(),
    check("mantenimiento.*.Responsable", "El Responsable es obligatorio")
      .optional({ checkFalsy: true })
      .not()
      .isEmpty(),
    check("mantenimiento.*.Precio", "El Precio es obligatorio")
      .optional({ checkFalsy: true })
      .not()
      .isEmpty(),
    check("mantenimiento.*.Precio", "El Precio debe ser un número")
      .optional({ checkFalsy: true })
      .isNumeric(),
    check("desinfeccion.*.Fecha", "La Fecha es obligatoria")
      .optional({ checkFalsy: true })
      .not()
      .isEmpty(),
    check("desinfeccion.*.Id_insumo", "El Id_insumo es obligatorio")
      .optional({ checkFalsy: true })
      .isMongoId(),
    check("desinfeccion.*.Id_insumo").custom(
      maquinariaHerramientasHelpers.validarIdInsumo
    ),
    check("desinfeccion.*.Responsable", "El Responsable es obligatorio")
      .optional({ checkFalsy: true })
      .not()
      .isEmpty(),
    validarCampos,
...
router.post(
  "/:id/mantenimiento",
  maquinariaHerramientasControllers.addMantenimiento
);
router.post(
  "/:id/desinfeccion",
  maquinariaHerramientasControllers.addDesinfeccion
);
